    ...
    >
      <div className="relative max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 md:py-6">
        ...
        <div className="mb-4 md:mb-6 flex items-start gap-2 bg-white/10 backdrop-blur-sm border-l-4 border-white/30 rounded-r-xl px-3 py-2">
          <svg className="w-4 h-4 text-white/70 shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
          </svg>
          <p className="text-xs text-white/80 leading-relaxed">
            <span className="font-semibold">Note:</span> Content is AI-generated and should be independently verified before use in decision-making.
          </p>
        </div>
          ...
          <div className="flex items-center gap-3 md:gap-5">
            ...
            <div className="relative group">
              <div className={clsx(
                ...
                theme.headerIconBg.replace('from-', 'bg-').split(' ')[0] + '/40'
              )}></div>
              <div className={clsx(
                ...
                <svg className={clsx('w-8 h-8 md:w-10 md:h-10 drop-shadow-lg', theme.headerIcon)} fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-4 md:mt-6 flex items-start gap-3">
          <div className={clsx(
            ...
            `bg-gradient-to-b ${theme.headerIconBg.split(' ')[0]} to-transparent`
          )}></div>
          <p className={clsx('text-sm md:text-base max-w-3xl leading-relaxed', theme.headerText)}>
